 ...
 * @property recurringPeriodicity Periodicity configuration for the recurring budget.
 */
@JsonClass(generateAdapter = true)
data class CreateRecurringBudgetRequest(
    ...
    @Json(name = "recurringPeriodicity") @field:Json(name = "recurringPeriodicity") var recurringPeriodicity: RecurringPeriodicity
)
